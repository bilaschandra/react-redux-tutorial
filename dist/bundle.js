...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modalReducer = __webpack_require__(184);
	...
	var cReducer = (0, _redux.combineReducers)({
	  reducer: _reducer2['default'],
	  modalReducer: _modalReducer2['default']
	});
	console.log(cReducer);
	var store = (0, _redux.createStore)(cReducer);
	//console.log(store);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _combineReducers = __webpack_require__(168);

	var _combineReducers2 = _interopRequireDefault(_combineReducers);

	var _bindActionCreators = __webpack_require__(170);

	var _bindActionCreators2 = _interopRequireDefault(_bindActionCreators);

	var _applyMiddleware = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPrototype = __webpack_require__(163),
	    isHostObject = __webpack_require__(164),
	    isObjectLike = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(167)(global || window || this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsCreateAll = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createProvider = __webpack_require__(175);

	var _createProvider2 = _interopRequireDefault(_createProvider);

	var _createConnect = __webpack_require__(177);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsCreateStoreShape = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsShallowEqual = __webpack_require__(178);
	...
	var _utilsWrapActionCreators = __webpack_require__(180);
...
/***/ function(module, exports) {
	...
	var modal = function modal(state, action) {
	  if (state === undefined) state = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GlobalModal = __webpack_require__(187);

	var _GlobalModal2 = _interopRequireDefault(_GlobalModal);
		...
		_createClass(TodoList, [{
			...
			value: function onSubmit(event) {
				...
				if (isEnterKey && isLongEnough) {
					input.value = '';
					this.props.dispatch((0, _actions.addTodo)(text));
				}
			}
		}, {
			key: 'toggleTodo',
			value: function toggleTodo(id, event) {
				this.props.dispatch((0, _actions.toggleTodo)(id));
			}
		}, {
			key: 'showModal',
			value: function showModal(e) {
				this.props.dispatch((0, _actions.showModal)(true));
			}
		}, {
			key: 'closeModal',
			value: function closeModal(e) {
				e.preventDefault();
				this.props.dispatch((0, _actions.showModal)(false));
			}
		}, {
			key: 'getFooter',
			value: function getFooter() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'div',
						{ className: 'col-lg-8 text-md-right' },
						_react2['default'].createElement(
							'a',
							{ href: '#', className: 'btn btn-secondary', onClick: this.closeModal.bind(this) },
							'Close'
						)
					)
				);
			...
			value: function render() {
				...
				if (this.props.modal.modalShown) {
					return _react2['default'].createElement(
						...
						'Are you sure you would like to publish this work order? Marketplace providers will be sending you requests for assignment. You will then review the requests to assign the provider of your choice'
					);
				}
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'div',
						null,
						_react2['default'].createElement('input', { type: 'button', name: 'modal', value: 'Show Modal', onClick: this.showModal.bind(this) })
					),
					_react2['default'].createElement(
						'div',
						null,
							...
							this.props.todos.map(function (t) {
								return _react2['default'].createElement(
									...
									{ key: t.id,
										...
										onClick: _this.toggleTodo.bind(_this, t.id) },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ModalPortal = React.createFactory(__webpack_require__(191));
	var ariaAppHider = __webpack_require__(206);
	var elementClass = __webpack_require__(207);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var focusManager = __webpack_require__(192);
	var scopeTab = __webpack_require__(194);
	var Assign = __webpack_require__(195);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var findTabbable = __webpack_require__(193);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var baseAssign = __webpack_require__(196),
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <https://lodash.com/license>
	 */
	var baseCopy = __webpack_require__(197),
	    keys = __webpack_require__(198);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <https://lodash.com/license>
	 */
	var bindCallback = __webpack_require__(203),
